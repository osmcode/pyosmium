...
htmlhelp_basename = 'npyosmiumdoc'
...
latex_documents = [
  ('index', 'npyosmium.tex', 'npyosmium Documentation',
...
man_pages = [
    ('tools_get_changes', 'npyosmium-get-changes', 'Download OSM change files',
     ['Sarah Hoffmann'], 1),
    ('tools_uptodate', 'npyosmium-up-to-date', 'Bring OSM files up-to-date',
     ['Sarah Hoffmann'], 1),
]
...
texinfo_documents = [
  ('index', 'npyosmium', 'npyosmium Documentation',
   'Sarah Hoffmann', 'npyosmium', 'One line description of project.',
   'Miscellaneous'),
]
